...
#define TIME_STEP 0.04f // Matches: 1/CONTROL_FREQUENCY (1/50 = 0.02) in Arduino
#define CONTROL_INTERVAL_MS 40 // Matches: CONTROL_INTERVAL (1000/50 = 20) in Arduino
// NO control FREQ
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - 
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - 
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - 
...
#define WEIGHTS_FILE "cart_pole_weights.bin"
        ...
        if (elapsed_ms >= CONTROL_INTERVAL_MS) {
            ...
            if (current_state.is_terminal) {
                ...
                if (training_mode) {
                    ...
                    // Remove automatic episode start
                    printf("\n===== EPISODE ENDED =====\n");
